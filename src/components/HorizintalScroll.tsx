    ...
    <div className="bg-black text-white overflow-x-hidden">
      ...
      <div className="h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center z-10 px-4">
          <h1 className="text-7xl md:text-9xl font-black mb-6 bg-gradient-to-r from-purple-900 via-red9400 to-cyan-200 bg-clip-text text-transparent">
            SCROLL
          </h1>
      ...
      <div ref={containerRef} className="relative">
        <div ref={panelsRef} className="flex h-screen w-fit">
          {projects.map((project, index) => (
            <div
              key={project.id}
              className="panel w-screen h-screen flex items-center justify-center relative flex-shrink-0"
            >
              {/* Background Gradient */}
              <div
              ...
              <div className="relative z-10 text-center px-8">
                ...
                <h2 className="project-title text-7xl md:text-9xl font-black mb-6 bg-gradient-to-r from-purple-700 via-red-300 to-cyan-200 bg-clip-text text-transparent">
                  {project.title}
                </h2>
                ...
                <div className="mt-12 flex justify-center gap-4">
                  <div
                    className={`w-20 h-1 bg-gradient-to-r ${project.color}`}
                  ></div>
                  <div
                    className={`w-20 h-1 bg-gradient-to-r ${project.color} opacity-50`}
                  ></div>
                  <div
                    className={`w-20 h-1 bg-gradient-to-r ${project.color} opacity-25`}
                  ></div>
                </div>
              </div>
              ...
              {/* Corner Accent */}
              <div
                className={`absolute bottom-8 right-8 w-32 h-32 bg-gradient-to-br ${project.color} rounded-full blur-3xl opacity-30`}
              ></div>
            </div>
          ))}
        </div>
      ...
      {/* Final Section */}
      <div className="h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-black via-purple-950 to-black">
        <div className="text-center z-10 px-4">
          ...
          <button className="px-12 py-6 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full text-xl font-bold hover:scale-110 transition-transform duration-300 shadow-2xl">
            Get Started
          </button>
        </div>
      </div>
